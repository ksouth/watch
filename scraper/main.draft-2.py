...
CONFIG_PATH = REPO_ROOT / "WATCH_CONFIG.py"
DRAFT_CONFIG_PATH = REPO_ROOT / "WATCH_CONFIG.draft-2.py"
...
def main() -> int:
    config_path = CONFIG_PATH if CONFIG_PATH.exists() else DRAFT_CONFIG_PATH
    module_name = "watch_config"
    import importlib.util
    spec = importlib.util.spec_from_file_location(module_name, config_path)
    module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(module)
    config = {
        "site_name": module.PROJECT_NAME,
        "base_url": module.BASE_URL,
        "sitemap_url": module.SITEMAP_URL,
        "archive_root": module.ARCHIVE_ROOT,
        "published_archive_base_url": getattr(module, "PUBLISHED_ARCHIVE_BASE_URL", None),
        "user_agent": module.USER_AGENT,
        "request_delay_seconds": module.REQUEST_DELAY_SECONDS,
        "request_timeout_seconds": module.REQUEST_TIMEOUT_SECONDS,
        "max_pages": module.MAX_URLS,
        "capture_assets_for_paths": getattr(module, "CAPTURE_ASSETS_FOR_PATHS", []),
        "document_extensions": module.DOCUMENT_EXTENSIONS,
    }
